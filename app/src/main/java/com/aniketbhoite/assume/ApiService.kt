...
interface ApiService {
    ...
    @Assume(
        responseCode = 200,
        responseFromFile = true,
        response = "/Users/nbt762/Documents/Personal/Newzz/data/abcd.json"
    )
    ...
    @Assume(
        responseCode = 200,
        responseFromFile = true,
        response = "/Users/nbt762/Documents/Personal/Newzz/data/abcd1.json"
    )
    @DELETE("v2/{newsId}/top-sport1.json?")
    suspend fun getSport1(
    ): NewsResponse

    @Assume(
        responseCode = 200,
        responseFromFile = true,
        response = "/Users/nbt762/Documents/Personal/Newzz/data/abcd2.json"
    )
    @DELETE("v2/{newsId}/top-sport2.json?")
    suspend fun getSport2(
    ): NewsResponse
    ...
    @Assume(
        responseCode = 200,
        responseFromFile = true,
        response = "/Users/nbt762/Documents/Personal/Newzz/data/abcd3.json"
    )
    @DELETE("v2/{newsId}/top-sport3.json?")
    suspend fun getSport3(
    ): NewsResponse

    @Assume(
        responseCode = 200,
        responseFromFile = true,
        response = "/Users/nbt762/Documents/Personal/Newzz/data/abcd4.json"
    )
    @DELETE("v2/{newsId}/top-sport4.json?")
    suspend fun getSport4(
    ): NewsResponse

    @Assume(
        responseCode = 200,
        responseFromFile = true,
        response = "/Users/nbt762/Documents/Personal/Newzz/data/abcd5.json"
    )
    @DELETE("v2/{newsId}/top-sport5.json?")
    suspend fun getSport5(
    ): NewsResponse

    @Assume(
        responseCode = 200,
        responseFromFile = true,
        response = "/Users/nbt762/Documents/Personal/Newzz/data/abcd6.json"
    )
    @DELETE("v2/{newsId}/top-sport6.json?")
    suspend fun getSport6(
    ): NewsResponse
